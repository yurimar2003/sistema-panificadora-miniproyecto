<!--include ("./view/pages/samples/login.html");-->
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3">
                ...
                <div class="mt-3">
                  <a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="./view/home.html">Iniciar sesión</a>
                </div>
                ...
                ¿No tienes una cuenta? <a href="./view/pages/samples/register.html" class="text-primary">Crear</a>
                </div>
              </form>
            </div>
          </div>
